...
//Time complextiy :-  O(n * log(range)), range = max (y+side) value - min y value
// Space complexity :- O(1)

// Approach :- 
// using binary search, we can traverse on all the possible values of y 
// and calculate the area below the line 
// also we'll pre-calculate the area of the complete squares 
// TopArea = (totalArea - bottomArea) or if both are equal then bottomArea = totalArea/2.0
// 
